...
public class DirectoryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ClassMapLister cli = new ClassMapLister(D2RServer.retrieveSystemLoader(getServletContext()).getMapping(), apiKey);

		Model resourceList = cli.classMapInventory(
				classMapName, limit);
		...
		Map<String,String> classMapLinks = new TreeMap<String,String>();
               for (String name: cli.classMapNames()) {
